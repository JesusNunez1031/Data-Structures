class QuickSort {
    ...
    Target of the partions is, given an array and an element x of array as pivot, put x at its correct position in sorted array and put all smaller elements (smaller than x) before x, and
    ...
    */
    ...
    public static void quickSort(int arr[], int begin, int end){
        ...
        if(begin < end){
            ...
            int partionIndex = partition(arr, begin, end);

            quickSort(arr, begin, partionIndex - 1);
